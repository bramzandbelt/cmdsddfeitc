...
plt_ips_calibration <- cmdsddfeitc::plot_ips_calibration(tibb = calibration_ips)
...
plt_ll_choice_pctgs <- 
  cmdsddfeitc::plot_ll_choice_pctgs(tibb = ll_choice_pctgs_for_plotting,
                       task = params$task)
# Show plot
plt_ll_choice_pctgs
...
# Show plot
plt_rt_percentiles <- 
  cmdsddfeitc::plot_rt_percentiles(tibb = rt_dist_for_plotting_grpd,
                                   task = params$task)
